...
/***/ function(module, exports, __webpack_require__) {
	...
	function objectParams2url(params) {
	  return Object.keys(params).filter(function (el) {
	    return !!el;
	  }).map(function (el) {
	...
	var josent = (function () {
	  ...
	  function _fetchJson(url, options) {
	    if (_typeof(options.body) === 'object') options.body = objectParams2url(options.body);
	    return (0, _isomorphicFetch2.default)(url, options).then(_checkStatus).then(_parseJSON);
	  }
